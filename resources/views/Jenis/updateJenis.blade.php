...
@section('title', 'Update Jenis')

@section('content')
<div class="content-wrapper">
    <div class="container-fluid p-0">
        <div class="col-12 d-none d-sm-block">
            <h3><strong>Update Jenis</strong></h3>
        ...
        <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ route('jenis.update', $data->id) }}" method="POST">
                  @csrf
                  @method('PUT')
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="ID Jenis" name="id" required value="{{ $data->id }}" readonly>
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="namaJenis" class="col-sm-2 control-label">Nama Jenis</label>
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="Nama Jenis" name="namaJenis" required value="{{ $data->namaJenis }}">
                      </div>
                    </div>
                  </div>
