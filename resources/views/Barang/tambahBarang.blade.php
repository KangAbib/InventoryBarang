            ...
            <form class="form-horizontal" action="{{ route('barang.store') }}" method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="ID Barang" name="id" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="namaBarang" class="col-sm-2 control-label">Nama Barang</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" id="inputPassword3" placeholder="Nama Barang" name="namaBarang" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="datepicker" name="tglMasuk" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="datepicker" name="tglKeluar" required>
                    </div>
                  </div>
                </div>
              </div>
