...
@section('title', 'Update Ruang')

@section('content')
<div class="content-wrapper">
    <div class="container-fluid p-0">
        <div class="col-12 d-none d-sm-block">
            <h3><strong>Update Ruang</strong></h3>
    ...
    <div class="box box-info">
            ...
            <form class="form-horizontal" action="{{ route('ruang.update', $data->id) }}" method="POST">
              @csrf
              @method('PUT')
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" placeholder="ID Ruang" name="id" required value="{{ $data->id }}" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label for="namaRuang" class="col-sm-2 control-label">Nama Ruang</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" placeholder="Nama Ruang" name="namaRuang" required value="{{ $data->namaRuang }}">
                  </div>
                </div>
                <div class="form-group">
