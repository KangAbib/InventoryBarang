            ...
            <form class="form-horizontal" action="{{ route('user.update', $data->id) }}" method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="id" placeholder="ID User" required value="{{ $data->id }}" readonly>
                  </div>
                </div>
                <div class="form-group">
                  <label for="noPegawai" class="col-sm-2 control-label">Nomor Pegawai</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="noPegawai" placeholder="Nomor Pegawai" required value="{{ $data->noPegawai }}">
                  </div>
                </div>
                <div class="form-group">
                  <label for="name" class="col-sm-2 control-label">Nama Pegawai</label>
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="name" placeholder="Nama Pegawai" required value="{{ $data->name }}">
                  </div>
                </div>
                <div class="form-group">
