...
<div class="content-wrapper">
    <div class="container-fluid p-0">
        ...
        <div class="tombol-tambah">
            <a href="{{ route('barang.create') }}"><button type="button" class="btn btn-success">Tambah</button></a>
        </div>
        @endif
        <br>
        <br>
        <table class="table table-bordered table-striped" id="table-daftar">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $item->jenis->namaJenis }}</td>
                    <td>{{ $item->kondisi->kondisiBarang }}</td>
                    <td>{{ $item->tglMasuk }}</td>
                    ...
                    <td>
                        ...
                        <form action="{{ route('barang.destroy', $item->id) }}" method="POST">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Tidak Dapat Menghapus "{{ $item->namaBarang}}" Karena Memiliki Relasi
                                        </div>
                            ...
                            <div class="modal fade" id="confirmDeleteModal-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus data "{{ $item->namaBarang}}" ?
                                        </div>
                                        <div class="modal-footer">
                            ...
                            <a href="{{ route('barang.edit', $item->id) }}"><button type="button" class="btn btn-info">Update</button></a>
                        </form>
                    </td>
                    @endif
                </tr>
