...
<div class="content-wrapper">
    <div class="container-fluid p-0">
        <div class="col-12 d-none d-sm-block">
            <h3><strong>Daftar Jenis</strong></h3>
        ...
        <div class="tombol-tambah">
            <a href="{{ route('jenis.create') }}"><button type="button" class="btn btn-success">Tambah</button></a>
        </div>
        <br>
        <br>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('jenis.destroy', $item->id) }}" method="POST">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Tidak Dapat Menghapus "{{ $item->namaJenis}}" Karena Memiliki Relasi
                                        </div>
                            ...
                            <div class="modal fade" id="confirmDeleteModal-{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Apakah Anda yakin ingin menghapus data "{{ $item->namaJenis}}"?
                                        </div>
                                        <div class="modal-footer">
                            ...
                            <a href="{{ route('jenis.edit', $item->id) }}"><button type="button" class="btn btn-info">Update</button></a>
                        </form>
                    </td>
                </tr>
                @endforeach
