            ...
            <form class="form-horizontal" action="{{ route('inventaris.store') }}" method="POST">
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" class="form-control" name="id" required placeholder="ID Inventaris">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="datepicker" required name="tglMasuk">
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <div class="input-group date">
                        ...
                        <input type="date" class="form-control pull-right" id="datepicker" required name="tglKeluar">
                    </div>
                  </div>
                </div>
              </div>
